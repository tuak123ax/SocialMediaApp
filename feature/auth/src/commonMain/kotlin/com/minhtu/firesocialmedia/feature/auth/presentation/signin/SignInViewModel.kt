...
class SignInViewModel(
    ...
    override fun setSignInLauncher(launcher: Any) {
        if (launcher is SignInLauncher) this.launcher = launcher
    }
    ...
    override fun handleSignInResult(credential: Any) {
        viewModelScope.launch(ioDispatcher) {
