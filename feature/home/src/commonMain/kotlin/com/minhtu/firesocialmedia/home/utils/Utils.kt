...
import com.minhtu.firesocialmedia.home.platform.createCallMessage
...
class Utils {
    companion object {
        fun findNewById(newId: String, listNews: ArrayList<com.minhtu.firesocialmedia.home.entity.news.NewsInstance>): com.minhtu.firesocialmedia.home.entity.news.NewsInstance? {
            for (new in listNews) {
