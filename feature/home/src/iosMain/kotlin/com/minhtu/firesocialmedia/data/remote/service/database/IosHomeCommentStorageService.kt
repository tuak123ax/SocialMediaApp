...
class IosHomeCommentStorageService : HomeCommentStorageService {
    ...
    override suspend fun saveInstanceToDatabase(
        ...
        return try {
            ...
            logMessage("IosHomeCommentStorageService", { "saveInstanceToDatabase failed: ${e.message}" })
            false
        }
    }
    ...
    override suspend fun deleteCommentFromDatabase(path: String, comment: BaseNewsInstance) {
        try {
            ...
            logMessage("IosHomeCommentStorageService", { "deleteCommentFromDatabase failed: ${e.message}" })
        }
    }
