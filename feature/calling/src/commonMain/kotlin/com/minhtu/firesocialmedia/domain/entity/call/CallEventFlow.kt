...
object CallEventFlow {
    ...
    /** Typed as Any? so :core has no dependency on the platform expect class WebRTCVideoTrack. Cast to WebRTCVideoTrack in :shared. */
    val localVideoTrack = MutableStateFlow<Any?>(null)
    val remoteVideoTrack = MutableStateFlow<Any?>(null)
