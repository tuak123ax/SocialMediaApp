...
fun CallStatusDTO.toDomain() : CallStatus = when (this) {
    CallStatusDTO.RINGING -> CallStatus.RINGING
    CallStatusDTO.ACCEPTED -> CallStatus.ACCEPTED
    CallStatusDTO.ENDED -> CallStatus.ENDED
    CallStatusDTO.VIDEO -> CallStatus.VIDEO
}

fun CallStatus.toDto() : CallStatusDTO = when (this) {
    CallStatus.RINGING -> CallStatusDTO.RINGING
    CallStatus.ACCEPTED -> CallStatusDTO.ACCEPTED
    CallStatus.ENDED -> CallStatusDTO.ENDED
    CallStatus.VIDEO -> CallStatusDTO.VIDEO
}
