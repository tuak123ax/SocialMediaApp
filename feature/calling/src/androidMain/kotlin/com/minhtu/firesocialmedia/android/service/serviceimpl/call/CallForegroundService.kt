...
import com.minhtu.firesocialmedia.constants.calling.Constants
...
import com.minhtu.firesocialmedia.calling.data.remote.mapper.user.toDomain
...
class CallForegroundService : Service() {
    private val databaseService : CallDatabaseService by inject()
    ...
    private val callManager: AudioCallService by inject()
    ...
    private fun startVideoCallAction(intent: Intent) {
        ...
        backgroundScope.launch {
            ...
            val remoteVideoOffer = remoteVideoOfferJsonString?.let { Json.decodeFromString<OfferAnswerDTO>(it).toDomainOfferAnswer() }
...
private fun OfferAnswerDTO.toDomainOfferAnswer(): OfferAnswer {
    return OfferAnswer(
        sdp = sdp,
        type = type,
        initiator = initiator
