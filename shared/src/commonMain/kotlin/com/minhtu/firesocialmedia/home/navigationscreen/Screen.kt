...
sealed class Screen(val title : String, val route : String,val icon : ImageVector)
{
    ...
    data object Friend : Screen("Friend", com.minhtu.firesocialmedia.home.navigationscreen.friend.Friend.getScreenName(), Icons.Default.Person)
    data object Notification : Screen("Notification", com.minhtu.firesocialmedia.home.navigationscreen.notification.Notification.getScreenName(), Icons.Default.Notifications)
